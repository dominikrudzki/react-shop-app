...
const Product: FC<ProductInfo> = (props) => {
  ...
  return (
    <div className="p-2 w-full sm:basis-1/2 dark:text-neutral-100 lg:basis-1/3">
      <Link
        to={{pathname: "/product", search: "?id=" + props.id.toString()}}
        className="grid h-full shadow-lg rounded-xl dark:bg-neutral-900 hover:scale-105 transition"
      >
        ...
        <div className="grid grid-cols-2 grid-rows-2 p-4">
          <span className="font-bold text-xl truncate">{props.name}</span>
